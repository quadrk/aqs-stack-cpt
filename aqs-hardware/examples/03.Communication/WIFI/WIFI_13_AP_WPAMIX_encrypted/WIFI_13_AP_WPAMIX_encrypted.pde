/*
 *  ------Waspmote WIFI_13 Example--------
 *
 *  Explanation: This example shows how to join to a WPAMIX encrypted AP
 *  
...
void setup()
{
  // Switch ON the WiFi module on the desired socketWIFI module on the desired socket.
  if( WIFI.ON(socket) == 1 )
  {    
  ...
  // 3. Sets Mixed WPA1 & WPA2-PSK encryptation // 1-64 Character 
  WIFI.setAuthKey(WPAMIX, AUTHKEY); 
