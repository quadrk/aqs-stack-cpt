/*
 *  ------Waspmote WIFI_12 Example--------
 *
 *  Explanation: This example shows how to join to a WPA encrypted AP
 *  
...
void setup()
{
  ...
  // 3. Sets WPA1 encryptation // 1-64 Characters 
