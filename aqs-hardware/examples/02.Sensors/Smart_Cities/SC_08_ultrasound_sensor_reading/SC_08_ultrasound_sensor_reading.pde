/*  
 *  --[SC_8] - Reading the Ultrasound Sensor on Smart Cities board-- 
 *  
...
void loop()
{
  ...
  value = SensorCities.readValue(SENS_CITIES_ULTRASOUND_3V3, SENS_US_WRA1);
  
  // Turn off the sensor
  SensorCities.setSensorMode(SENS_OFF, SENS_CITIES_ULTRASOUND_3V3);
  
  // Part 2: USB printing
  // Print the distance read value through the USB
